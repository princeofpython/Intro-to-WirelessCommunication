...
ylabel('BER')
xlabel('E_b/N_0 (dB)')
title('Bit Error Rate for Coherent DQPSK with ISI varying \alpha')
legend('\alpha = 0.1','\alpha = 0.2','\alpha = 0.3','\alpha = 0.5','\alpha = 1', 'theoretical, no ISI')